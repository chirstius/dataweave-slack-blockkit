...
*
* Extended beyond the original 2022 set to include the modern input elements
* (`number_input`, `email_text_input`, `url_text_input`, `rich_text_input`,
* `file_input`), the `datetimepicker`, and the `workflow_button`.
*/
type Element = Button | WorkflowButton | Checkbox | DatePicker | DatetimePicker | TimePicker
    | Image | MultiSelectMenu | OverflowMenu | RadioButtonGroup | SelectMenu
    | PlainTextInput | NumberInput | EmailInput | UrlInput | RichTextInput | FileInput
...
// ============================================================================================
// Modern elements (added post-2022). See https://docs.slack.dev/reference/block-kit/block-elements
// ============================================================================================

/**
* Represents a datetime picker element.
*
* https://docs.slack.dev/reference/block-kit/block-elements/datetime-picker-element
*/
type DatetimePicker = WithOptionalConfirm & WithOptionalFocus & {
    'type': "datetimepicker",
    action_id: String,
...
*/
type NumberInput = WithOptionalFocus & {
    'type': "number_input",
...
*/
type EmailInput = WithOptionalFocus & {
...
*/
type UrlInput = WithOptionalFocus & {
    'type': "url_text_input",
    action_id?: String,
    initial_value?: String,
    dispatch_action_config?: Dispatch,
...
/**
* Represents a workflow button element.
*
